...
export const WishlistCards = ({Title, description,noofbedrooms,id}) => {
  ...
  return(
    ...
    <div class="listing">
      ...
      <div><button class="remove-button" style={{marginRight : "20px"}} onClick={deletedata}><i class="fas fa-trash-alt"></i> Remove</button><button class="remove-button" id={id} onClick={(e) => navigate('/details' , {state : {id : e.target.id}})}><i class="fas fa-trash-alt"></i> View Details</button></div>
      </div>
    </div>
  </div>
  </div>
